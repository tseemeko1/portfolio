      ...
      <div className="container mx-auto mt-0 pt-0">
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            >
              Hi, I’m Tsholofelo — a Solutions Engineer and Data-driven Software Engineer with hands-on experience designing and delivering end-to-end digital and analytics solutions. I specialise in building scalable data platforms, business intelligence systems, and full-stack applications that turn complex business requirements into clear, actionable insights.

I work across data engineering, analytics, and application development, using modern web technologies 
            </motion.p>
            <motion.div
              variants={fadeIn("up", 0.6)}
              initial="hidden"
            ...
            >
              <button className="btn btn-lg">
                ...
                <Link to="contact" className=" cursor-pointer" >  Request for a Quote</Link>
              </button>
