                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 items-end">
                      <button
                        ...
                        className="btn w-9 h-9 mb-[42px] flex justify-center items-center hover:scale-110 transition-transform cursor-pointer"
                      >
                        <BsArrowUpRight />
                      </button>
                      <button
                        onClick={onShowPricing}
                        className="text-gradient text-sm hover:gap-2 transition-all inline-flex items-center gap-1 group cursor-pointer"
                      >
                        {link}
